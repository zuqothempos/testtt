...
local function sendWebhook(title, description, color, fields)
    -- color = entier décimal ex: 0x00FF00 = 65280
    local embedFields = {}
    if fields then
...
local lastMoney       = nil  -- pour le delta
local lastStatsSent   = nil  -- pour l'envoi webhook 15min
...
local function buildGUI(W)
    ...
    local setDelta  = tab3:AddInfo("📈", "Dernier gain",   "+0")   -- ✅ delta argent
    ...
    task.spawn(function()
        while true do
            ...
            if timerRunning and sessionStart then
                ...
                -- ✅ Delta : affiche +X ou -X en couleur
                if delta > 0 then
                ...
                -- Envoi webhook toutes les 15 minutes
